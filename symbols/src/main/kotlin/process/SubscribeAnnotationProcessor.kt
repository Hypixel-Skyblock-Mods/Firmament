...
class SubscribeAnnotationProcessor(
    ...
    override fun finish() {
        ...
        val subscriptionsFile =
            codeGenerator
                .createNewFile(dependencies, "moe.nea.firmod.annotations.generated.$sourceSetName", generatedFileName)
                .bufferedWriter()
        subscriptionsFile.apply {
            appendLine("// This file is @generated by SubscribeAnnotationProcessor")
            appendLine("// Do not edit")
            appendLine("package moe.nea.firmod.annotations.generated.$sourceSetName")
            appendLine()
            appendLine("import moe.nea.firmod.events.subscription.*")
            appendLine()
	        appendLine("@Suppress()")
        ...
        val metaInf = codeGenerator.createNewFileByPath(
            dependencies,
            "META-INF/services/moe.nea.firmod.events.subscription.SubscriptionList", extensionName = "")
            .bufferedWriter()
