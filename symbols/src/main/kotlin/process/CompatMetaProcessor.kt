...
class CompatMetaProcessor(val logger: KSPLogger, val codeGenerator: CodeGenerator, val sourceSetName: String) :
	...
	override fun process(resolver: Resolver): List<KSAnnotated> {
		...
		packages.add("moe.nea.firmod.annotations.generated.$sourceSetName")
		val compatMeta = resolver.getSymbolsWithAnnotation("moe.nea.firmod.util.compatloader.CompatMeta")
		...
		val compatFile =
			codeGenerator.createNewFile(dependencies, "moe.nea.firmod.annotations.generated.$sourceSetName", generatedFileName)
				.bufferedWriter()
		compatFile.appendLine("// This file is @generated by SubscribeAnnotationProcessor")
		compatFile.appendLine("// Do not edit")
		compatFile.appendLine("package moe.nea.firmod.annotations.generated.$sourceSetName")
		compatFile.appendLine("class $generatedFileName : moe.nea.firmod.util.compatloader.ICompatMetaGen {")
		compatFile.appendLine("""
	override fun owns(className: String): Boolean {
		return moe.nea.firmod.util.compatloader.CompatHelper.isOwnedByPackage(className, ${
			packages.joinToString { "\"" + it + "\"" }
		})
	}

	override val meta: moe.nea.firmod.util.compatloader.ICompatMeta
...
""")
		...
		val metaInf = codeGenerator.createNewFileByPath(
			dependencies,
			"META-INF/services/moe.nea.firmod.util.compatloader.ICompatMetaGen", extensionName = "")
			.bufferedWriter()
		metaInf.append("moe.nea.firmod.annotations.generated.$sourceSetName.")
