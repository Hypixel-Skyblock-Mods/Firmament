package moe.nea.firmod.mixins.sodium.custommodels;
...
public class PatchBlockModelInSodiumChunkGenerator {
	...
	private BlockStateModel replaceBlockModel(BlockStateModelSet instance, BlockState state, Operation<BlockStateModel> original,
