...
import moe.nea.firmod.compat.rei.FirmodReiPlugin.Companion.asItemEntry
...
object SBItemEntryDefinition : EntryDefinition<SBItemStack> {
	...
	override fun getType(): EntryType<SBItemStack> = EntryType.deferred(FirmodReiPlugin.SKYBLOCK_ITEM_TYPE_ID)
