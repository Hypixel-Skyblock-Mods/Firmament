...
import moe.nea.firmod.compat.rei.recipes.GenericREIRecipeCategory
import moe.nea.firmod.compat.rei.recipes.SBKatRecipe
import moe.nea.firmod.compat.rei.recipes.SBMobDropRecipe
import moe.nea.firmod.compat.rei.recipes.SBRecipe
import moe.nea.firmod.compat.rei.recipes.SBReforgeRecipe
import moe.nea.firmod.compat.rei.recipes.SBShopRecipe
import moe.nea.firmod.events.HandledScreenPushREIEvent
import moe.nea.firmod.features.inventory.CraftingOverlay
...
import moe.nea.firmod.repo.recipes.SBCraftingRecipeRenderer
import moe.nea.firmod.repo.recipes.SBEssenceUpgradeRecipeRenderer
import moe.nea.firmod.repo.recipes.SBForgeRecipeRenderer
import moe.nea.firmod.util.MC
import moe.nea.firmod.util.SkyblockId
import moe.nea.firmod.util.guessRecipeId
import moe.nea.firmod.util.mc.RequiresComponents
import moe.nea.firmod.util.skyblockId
import moe.nea.firmod.util.unformattedString


class FirmodReiPlugin : REIClientPlugin {
	...
	companion object {
		...
		val SKYBLOCK_ITEM_TYPE_ID = Identifier.fromNamespaceAndPath("firmod", "skyblockitems")
	}
