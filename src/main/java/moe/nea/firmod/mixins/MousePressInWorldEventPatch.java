...
public class MousePressInWorldEventPatch {
	...
	public boolean onKeyBoardInWorld(InputConstants.Key key, @Local(argsOnly = true, print = true) MouseButtonInfo rawButtonInfo) { // TODO: handle modified mouse click instead
