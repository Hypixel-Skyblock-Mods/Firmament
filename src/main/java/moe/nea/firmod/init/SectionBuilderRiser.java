...
// TODO: BlockStateModelSet might replace _all_ of this
	...
	String CustomBlockTextures = "moe.nea.firmod.features.texturepack.CustomBlockTextures";
	...
	private void handleIndigo(MethodNode method) {
		...
		if (blockPosVar == null || blockStateVar == null) {
			System.err.println("Firmod could inject into indigo: missing either block pos or blockstate");
			return;
		}
