...
import moe.nea.firmod.commands.DurationArgumentType
...
object TimerFeature {
	...
	fun tick(event: TickEvent) {
		timers.removeAll {
			if (it.isDone()) {
				MC.sendChat(tr("firmod.timer.finished",
