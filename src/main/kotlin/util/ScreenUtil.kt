...
object ScreenUtil {
    ...
    fun setScreenLater(nextScreen: Screen?) {
        ...
        if (nog != null) {
            Firmod.logger.warn("Setting screen ${if (nextScreen == null) "null" else nextScreen::class.qualifiedName} to be opened later, but ${nog::class.qualifiedName} is already queued.")
            return
        }
