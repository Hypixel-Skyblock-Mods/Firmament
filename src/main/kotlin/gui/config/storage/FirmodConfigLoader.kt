...
import moe.nea.firmod.util.SBData.NULL_UUID
import moe.nea.firmod.util.TimeMark
import moe.nea.firmod.util.data.IConfigProvider
import moe.nea.firmod.util.data.IDataHolder
import moe.nea.firmod.util.data.ProfileKeyedConfig
import moe.nea.firmod.util.json.intoGson
import moe.nea.firmod.util.json.intoKotlinJson

object FirmodConfigLoader {
	val currentConfigVersion = 1000
	val configFolder = Path("config/firmod")
		.toAbsolutePath()
